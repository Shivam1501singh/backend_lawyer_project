...
const run = async () => {
  const requestBody = {
    ...
    // Aadhaar field variations
    aadhaarNumber: '290087531223',
    aadhaar_number: '290087531223',
    aadharNumber: '290087531223',
    aadhar_number: '290087531223',
    aadhaar: '290087531223',
    aadhar: '290087531223'
  };
  ...
  const headers = {
    ...
    'api_key': process.env.IDSPAY_API_KEY || '9a75388c-0370-4070-b007-0fad98c0db79',
    'Authorization': `Bearer ${process.env.IDSPAY_API_KEY || '9a75388c-0370-4070-b007-0fad98c0db79'}`
  };

  try {
    const url = 'https://javabackend.idspay.in/api/v1/prod/srv2/validation/digilocker-digital-kyc';
    console.log('Sending request to IDSPay with Aadhaar variations...');

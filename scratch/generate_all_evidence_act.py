# Complete Indian Evidence Act, 1872 Dataset Builder
import json
import os
...
add_sec("21", 2, "II", "OF THE RELEVANCY OF FACTS", "Proof of admissions against persons making them, and by or on their behalf",
...
add_sec("22", 2, "II", "OF THE RELEVANCY OF FACTS", "When oral admissions as to contents of documents are relevant",
...
add_sec("22A", 2, "II", "OF THE RELEVANCY OF FACTS", "When oral admission as to contents of electronic records are relevant",
...
add_sec("23", 2, "II", "OF THE RELEVANCY OF FACTS", "Admissions in civil cases when relevant",
...
add_sec("24", 2, "II", "OF THE RELEVANCY OF FACTS", "Confession caused by inducement, threat or promise, when irrelevant in criminal proceeding",
"""A confession made by an accused person is irrelevant in a criminal proceeding, if the making of the confession appears to the Court to have been caused by any inducement, threat or promise having reference to the charge against the accused person, proceeding from a person in authority and sufficient, in the opinion of the Court, to give the accused person grounds which would appear to him reasonable for supposing that by making it he would gain any advantage or avoid any evil of a temporal nature in reference to the proceedings against him.""")

add_sec("25", 2, "II", "OF THE RELEVANCY OF FACTS", "Confession to police-officer not to be proved",
"""No confession made to a police-officer, shall be proved as against a person accused of any offence.""")

add_sec("26", 2, "II", "OF THE RELEVANCY OF FACTS", "Confession by accused while in custody of police not to be proved against him",
...
add_sec("27", 2, "II", "OF THE RELEVANCY OF FACTS", "How much of information received from accused may be proved",
"""Provided that, when any fact is deposed to as discovered inconsequence of information received from a person accused of any offence, in the custody of a police-officer, so much of such information, whether it amounts to a confession or not, as relates distinctly to the fact thereby discovered, may be proved.""")

add_sec("28", 2, "II", "OF THE RELEVANCY OF FACTS", "Confession made after removal of impression caused by inducement, threat or promise, relevant",
...
add_sec("29", 2, "II", "OF THE RELEVANCY OF FACTS", "Confession otherwise relevant not to become irrelevant because of promise of secrecy, etc.",
...
add_sec("30", 2, "II", "OF THE RELEVANCY OF FACTS", "Consideration of proved confession affecting person making it and others jointly under trial for same offence",
...
add_sec("31", 2, "II", "OF THE RELEVANCY OF FACTS", "Admissions not conclusive proof, but may estop",
"""Admissions are not conclusive proof of the matters admitted but they may operate as estoppels under the provisions hereinafter contained.""")

add_sec("32", 2, "II", "OF THE RELEVANCY OF FACTS", "Cases in which statement of relevant fact by person who is dead or cannot be found, etc., is relevant",
...
add_sec("33", 2, "II", "OF THE RELEVANCY OF FACTS", "Relevancy of certain evidence for proving, in subsequent proceeding, the truth of facts therein stated",
...
add_sec("34", 2, "II", "OF THE RELEVANCY OF FACTS", "Entries in books of account when relevant",
...
add_sec("35", 2, "II", "OF THE RELEVANCY OF FACTS", "Relevancy of entry in public record made in performance of duty",
...
add_sec("36", 2, "II", "OF THE RELEVANCY OF FACTS", "Relevancy of statements in maps, charts and plans",
...
add_sec("37", 2, "II", "OF THE RELEVANCY OF FACTS", "Relevancy of statement as to fact of public nature contained in certain Acts or notifications",
...
add_sec("38", 2, "II", "OF THE RELEVANCY OF FACTS", "Relevancy of statements as to any law contained in law-books",
"""When the Court has to form an opinion as to a law of any country, any statement of such law contained in a book purporting to be printed or published under the authority of the Government of such country and to contain any such law, and any report of a ruling of the Courts of such country contained in a book purporting to be a report of such rulings, is relevant.""")

add_sec("39", 2, "II", "OF THE RELEVANCY OF FACTS", "What evidence to be given when statement forms part of a conversation, document, electronic record, book or series of letters or papers",
"""When any statement of which evidence is given forms part of a longer statement, or of a conversation or part of an isolated document, or is contained in a document which forms part of a book, or is contained in part of electronic record or of a connected series of letters or papers, evidence shall be given of so much and no more of the statement, conversation, document, electronic record, book or series of letters or papers as the Court considers necessary in that particular case to the full understanding of the nature and effect of the statement, and of the circumstances under which it was made.""")

add_sec("40", 2, "II", "OF THE RELEVANCY OF FACTS", "Previous judgments relevant to bar a second suit or trial",
...
add_sec("41", 2, "II", "OF THE RELEVANCY OF FACTS", "Relevancy of certain judgments in probate, etc., jurisdiction",
...
add_sec("42", 2, "II", "OF THE RELEVANCY OF FACTS", "Relevancy and effect of judgments, orders or decrees, other than those mentioned in section 41",
...
add_sec("43", 2, "II", "OF THE RELEVANCY OF FACTS", "Judgments, etc., other than those mentioned in sections 40, 41 and 42, when relevant",
...
add_sec("44", 2, "II", "OF THE RELEVANCY OF FACTS", "Fraud or collusion in obtaining judgment, or incompetency of Court, may be proved",
...
add_sec("45", 2, "II", "OF THE RELEVANCY OF FACTS", "Opinions of experts",
...
add_sec("45A", 2, "II", "OF THE RELEVANCY OF FACTS", "Opinion of Examiner of Electronic Evidence",
...
add_sec("46", 2, "II", "OF THE RELEVANCY OF FACTS", "Facts bearing upon opinions of experts",
...
add_sec("47", 2, "II", "OF THE RELEVANCY OF FACTS", "Opinion as to hand-writing, when relevant",
...
add_sec("47A", 2, "II", "OF THE RELEVANCY OF FACTS", "Opinion as to digital signature, when relevant",
...
add_sec("48", 2, "II", "OF THE RELEVANCY OF FACTS", "Opinion as to existence of right or custom, when relevant",
...
add_sec("49", 2, "II", "OF THE RELEVANCY OF FACTS", "Opinion as to usages, tenets, etc., when relevant",
...
add_sec("50", 2, "II", "OF THE RELEVANCY OF FACTS", "Opinion on relationship, when relevant",
...
add_sec("51", 2, "II", "OF THE RELEVANCY OF FACTS", "Grounds of opinion, when relevant",
...
add_sec("52", 2, "II", "OF THE RELEVANCY OF FACTS", "In civil cases character to prove conduct imputed, irrelevant",
...
add_sec("53", 2, "II", "OF THE RELEVANCY OF FACTS", "In criminal cases previous good character relevant",
"""In criminal proceedings, the fact that the person accused is of a good character, is relevant.""")

add_sec("53A", 2, "II", "OF THE RELEVANCY OF FACTS", "Evidence of character or previous sexual experience not relevant in certain cases",
...
add_sec("54", 2, "II", "OF THE RELEVANCY OF FACTS", "Previous bad character not relevant, except in reply",
...
add_sec("55", 2, "II", "OF THE RELEVANCY OF FACTS", "Character as affecting damages",
...
add_sec("56", 3, "III", "FACTS WHICH NEED NOT BE PROVED", "Fact judicially noticeable need not be proved",
"""No fact of which the Court will take judicial notice need be proved.""")

add_sec("57", 3, "III", "FACTS WHICH NEED NOT BE PROVED", "Facts of which Court must take judicial notice",
...
add_sec("58", 3, "III", "FACTS WHICH NEED NOT BE PROVED", "Facts admitted need not be proved",
...
add_sec("59", 4, "IV", "OF ORAL EVIDENCE", "Proof of facts by oral evidence",
"""All facts, except the [contents of documents or electronic records], may be proved by oral evidence.""")

add_sec("60", 4, "IV", "OF ORAL EVIDENCE", "Oral evidence must be direct",
...
add_sec("61", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof of contents of documents",
"""The contents of documents may be proved either by primary or by secondary evidence.""")

add_sec("62", 5, "V", "OF DOCUMENTARY EVIDENCE", "Primary evidence",
...
add_sec("63", 5, "V", "OF DOCUMENTARY EVIDENCE", "Secondary evidence",
...
add_sec("64", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof of documents by primary evidence",
"""Documents must be proved by primary evidence except in the cases hereinafter mentioned.""")

add_sec("65", 5, "V", "OF DOCUMENTARY EVIDENCE", "Cases in which secondary evidence relating to documents may be given",
...
add_sec("65A", 5, "V", "OF DOCUMENTARY EVIDENCE", "Special provisions as to evidence relating to electronic record",
"""The contents of electronic records may be proved in accordance with the provisions of section 65B.""")

add_sec("65B", 5, "V", "OF DOCUMENTARY EVIDENCE", "Admissibility of electronic records",
...
add_sec("66", 5, "V", "OF DOCUMENTARY EVIDENCE", "Rules as to notice to produce",
...
add_sec("67", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof of signature and handwriting of person alleged to have signed or written document produced",
...
add_sec("67A", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof as to electronic signature",
...
add_sec("68", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof of execution of document required by law to be attested",
...
add_sec("69", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof where no attesting witness found",
...
add_sec("70", 5, "V", "OF DOCUMENTARY EVIDENCE", "Admission of execution by party to attested document",
...
add_sec("71", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof when attesting witness denies the execution",
"""If the attesting witness denies or does not recollect the execution of the document, its execution may be proved by other evidence.""")

add_sec("72", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof of document not required by law to be attested",
"""An attested document not required by law to be attested may be proved as if it was unattested.""")

add_sec("73", 5, "V", "OF DOCUMENTARY EVIDENCE", "Comparison of signature, writing or seal with others admitted or proved",
...
add_sec("73A", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof as to verification of digital signature",
...
add_sec("74", 5, "V", "OF DOCUMENTARY EVIDENCE", "Public documents",
...
add_sec("75", 5, "V", "OF DOCUMENTARY EVIDENCE", "Private documents",
"""All other documents are private.""")

add_sec("76", 5, "V", "OF DOCUMENTARY EVIDENCE", "Certified copies of public documents",
...
add_sec("77", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof of documents by production of certified copies",
...
add_sec("78", 5, "V", "OF DOCUMENTARY EVIDENCE", "Proof of other official documents",
...
add_sec("79", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to genuineness of certified copies",
...
add_sec("80", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to documents produced as record of evidence",
...
add_sec("81", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to Gazettes, newspapers, private Acts of Parliament and other documents",
...
add_sec("81A", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to Gazettes in electronic forms",
...
add_sec("82", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to document admissible in England without proof of seal or signature",
...
add_sec("83", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to maps or plans made by authority of Government",
...
add_sec("84", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to collections of laws and reports of decisions",
...
add_sec("85", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumptions as to powers-of-attorney",
...
add_sec("85A", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to electronic agreements",
...
add_sec("85B", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to electronic records and electronic signatures",
...
add_sec("85C", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to Electronic Signature Certificates",
...
add_sec("86", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to certified copies of foreign judicial records",
...
add_sec("87", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to books, maps and charts",
"""The Court may presume that any book to which it may refer for information on matters of public or general interest, and that any published map or chart, the statements of which are relevant facts, and which is produced for its inspection, was written and published by the person, and at the time and place, by whom or at which it purports to have been written or published.""")

add_sec("88", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to telegraphic messages",
"""The Court may presume that a message, forwarded from a telegraph office to the person to whom such message purports to be addressed, corresponds with a message delivered for transmission at the office from which the message purports to be sent; but the Court shall not make any presumption as to the person by whom such message was delivered for transmission.""")

add_sec("88A", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to electronic messages",
...
add_sec("89", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to due execution, etc., of documents not produced",
...
add_sec("90", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to documents thirty years old",
...
add_sec("90A", 5, "V", "OF DOCUMENTARY EVIDENCE", "Presumption as to electronic records five years old",
...
add_sec("91", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Evidence of terms of contracts, grants and other dispositions of property reduced to form of document",
...
add_sec("92", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Exclusion of evidence of oral agreement",
...
add_sec("93", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Exclusion of evidence to explain or amend ambiguous document",
...
add_sec("94", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Exclusion of evidence against application of document to existing facts",
...
add_sec("95", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Evidence as to document unmeaning reference to existing facts",
...
add_sec("96", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Evidence as to application of language which can apply to one only of several persons",
...
add_sec("97", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Evidence as to application of language to one of two sets of facts, to neither of which the whole correctly applies",
...
add_sec("98", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Evidence as to meaning of illegible characters, etc.",
...
add_sec("99", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Who may give evidence of agreement varying terms of document",
...
add_sec("100", 6, "VI", "OF THE EXCLUSION OF ORAL BY DOCUMENTARY EVIDENCE", "Saving of provisions of Indian Succession Act relating to wills",
"""Nothing in this Chapter contained shall be taken to affect any of the provisions of the Indian Succession Act, 1865 (10 of 1865) as to the construction of wills.""")

# PART III – PRODUCTION AND EFFECT OF EVIDENCE
# CHAPTER VII – OF THE BURDEN OF PROOF
add_sec("101", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proof",
...
add_sec("102", 7, "VII", "OF THE BURDEN OF PROOF", "On whom burden of proof lies",
...
add_sec("103", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proof as to particular fact",
...
add_sec("104", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proving fact to be proved to make evidence admissible",
...
add_sec("105", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proving that case of accused comes within exceptions",
...
add_sec("106", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proving fact especially within knowledge",
...
add_sec("107", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proving death of person known to have been alive within thirty years",
"""When the question is whether a man is alive or dead, and it is shown that he was alive within thirty years, the burden of proving that he is dead is on the person who affirms it.""")

add_sec("108", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proving that person is alive who has not been heard of for seven years",
"""[Provided that when] the question is whether a man is alive or dead, and it is proved that he has not been heard of for seven years by those who would naturally have heard of him if he had been alive, the burden of proving that he is alive is [shifted to] the person who affirms it.""")

add_sec("109", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proof as to relationship in the cases of partners, landlord and tenant, principal and agent",
...
add_sec("110", 7, "VII", "OF THE BURDEN OF PROOF", "Burden of proof as to ownership",
"""When the question is whether any person is owner of anything of which he is shown to be in possession, the burden of proving that he is not the owner is on the person who affirms that he is not the owner.""")

add_sec("111", 7, "VII", "OF THE BURDEN OF PROOF", "Proof of good faith in transactions where one party is in relation of active confidence",
...
add_sec("111A", 7, "VII", "OF THE BURDEN OF PROOF", "Presumption as to certain offences",
...
add_sec("112", 7, "VII", "OF THE BURDEN OF PROOF", "Birth during marriage, conclusive proof of legitimacy",
"""The fact that any person was born during the continuance of a valid marriage between his mother and any man, or within two hundred and eighty days after its dissolution, the mother remaining unmarried, shall be conclusive proof that he is the legitimate son of that man, unless it can be shown that the parties to the marriage had no access to each other at any time when he could have been begotten.""")

add_sec("113", 7, "VII", "OF THE BURDEN OF PROOF", "Proof of cession of territory",
...
add_sec("113A", 7, "VII", "OF THE BURDEN OF PROOF", "Presumption as to abetment of suicide by a married woman",
...
add_sec("113B", 7, "VII", "OF THE BURDEN OF PROOF", "Presumption as to dowry death",
"""When the question is whether a person has committed the dowry death of a woman and it is shown that soon before her death such woman had been subjected by such person to cruelty or harassment for, or in connection with, any demand for dowry, the court shall presume that such person had caused the dowry death.

Explanation. –– For the purposes of this section, “dowry death” shall have the same meaning as in section 304B of the Indian Penal Code (45 of 1860).""")

add_sec("114", 7, "VII", "OF THE BURDEN OF PROOF", "Court may presume existence of certain facts",
...
add_sec("114A", 7, "VII", "OF THE BURDEN OF PROOF", "Presumption as to absence of consent in certain prosecution for rape",
...
add_sec("115", 8, "VIII", "ESTOPPEL", "Estoppel",
...
add_sec("116", 8, "VIII", "ESTOPPEL", "Estoppel of tenants and of licensee of person in possession",
...
add_sec("117", 8, "VIII", "ESTOPPEL", "Estoppel of acceptor of bill of exchange, bailee or licensee",
...
add_sec("118", 9, "IX", "OF WITNESSES", "Who may testify",
"""All persons shall be competent to testify unless the Court considers that they are prevented from understanding the questions put to them, or from giving rational answers to those questions, by tender years, extreme old age, disease, whether of body or mind, or any other cause of the same kind.

Explanation. –– A lunatic is not incompetent to testify, unless he is prevented by his lunacy from understanding the questions put to him and giving rational answers to them.""")

add_sec("119", 9, "IX", "OF WITNESSES", "Witness unable to communicate verbally",
...
add_sec("120", 9, "IX", "OF WITNESSES", "Parties to civil suit, and their wives or husbands. Husband or wife of person under criminal trial",
...
add_sec("121", 9, "IX", "OF WITNESSES", "Judges and Magistrates",
...
add_sec("122", 9, "IX", "OF WITNESSES", "Communications during marriage",
"""No person who is or has been married, shall be compelled to disclose any communication made to him during marriage by any person to whom he is or has been married; nor shall he be permitted to disclose any such communication, unless the person who made it, or his representative in interest, consents, except in suits between married persons, or proceedings in which one married person is prosecuted for any crime committed against the other.""")

add_sec("123", 9, "IX", "OF WITNESSES", "Evidence as to affairs of State",
"""No one shall be permitted to give any evidence derived from unpublished official records relating to any affairs of State, except with the permission of the officer at the head of the department concerned, who shall give or withhold such permission as he thinks fit.""")

add_sec("124", 9, "IX", "OF WITNESSES", "Official communications",
"""No public officer shall be compelled to disclose communications made to him in official confidence, when he considers that the public interests would suffer by the disclosure.""")

add_sec("125", 9, "IX", "OF WITNESSES", "Information as to commission of offences",
...
add_sec("126", 9, "IX", "OF WITNESSES", "Professional communications",
...
add_sec("127", 9, "IX", "OF WITNESSES", "Section 126 to apply to interpreters, etc.",
...
add_sec("128", 9, "IX", "OF WITNESSES", "Privilege not waived by volunteering evidence",
...
add_sec("129", 9, "IX", "OF WITNESSES", "Confidential communications with legal advisers",
...
add_sec("130", 9, "IX", "OF WITNESSES", "Production of title-deeds of witness not a party",
...
add_sec("131", 9, "IX", "OF WITNESSES", "Production of documents or electronic records which another person, having possession, could refuse to produce",
...
add_sec("132", 9, "IX", "OF WITNESSES", "Witness not excused from answering on ground that answer will criminate",
...
add_sec("133", 9, "IX", "OF WITNESSES", "Accomplice",
"""An accomplice shall be a competent witness against an accused person; and a conviction is not illegal merely because it proceeds upon the uncorroborated testimony of an accomplice.""")

add_sec("134", 9, "IX", "OF WITNESSES", "Number of witnesses",
"""No particular number of witnesses shall in any case be required for the proof of any fact.""")

# CHAPTER X – OF THE EXAMINATION OF WITNESSES
add_sec("135", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Order of production and examination of witnesses",
...
add_sec("136", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Judge to decide as to admissibility of evidence",
...
add_sec("137", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Examination-in-chief, Cross-examination, Re-examination",
...
add_sec("138", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Order of examinations, Direction of re-examination",
...
add_sec("139", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Cross-examination of person called to produce a document",
...
add_sec("140", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Witnesses to character",
"""Witnesses to character may be cross-examined and re-examined.""")

add_sec("141", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Leading questions",
"""Any question suggesting the answer which the person putting it wishes or expects to receive, is called a leading question.""")

add_sec("142", 10, "X", "OF THE EXAMINATION OF WITNESSES", "When they must not be asked",
"""Leading questions must not, if objected to by the adverse party, be asked in an examination-in-chief, or in a re-examination, except with the permission of the Court.

The Court shall permit leading questions as to matters which are introductory or undisputed, or which have, in its opinion, been already sufficiently proved.""")

add_sec("143", 10, "X", "OF THE EXAMINATION OF WITNESSES", "When they may be asked",
"""Leading questions may be asked in cross-examination.""")

add_sec("144", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Evidence as to matters in writing",
...
add_sec("145", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Cross-examination as to previous statements in writing",
"""A witness may be cross-examined as to previous statements made by him in writing or reduced into writing, and relevant to matters in question, without such writing being shown to him, or being proved; but, if it is intended to contradict him by the writing, his attention must, before the writing can be proved, be called to those parts of it which are to be used for the purpose of contradicting him.""")

add_sec("146", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Questions lawful in cross-examination",
...
add_sec("147", 10, "X", "OF THE EXAMINATION OF WITNESSES", "When witness to be compelled to answer",
...
add_sec("148", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Court to decide when question shall be asked and when witness compelled to answer",
...
add_sec("149", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Question not to be asked without reasonable grounds",
...
add_sec("150", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Procedure of Court in case of question being asked without reasonable grounds",
...
add_sec("151", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Indecent and scandalous questions",
...
add_sec("152", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Questions intended to insult or annoy",
"""The Court shall forbid any question which appears to it to be intended to insult or annoy, or which, though proper in itself, appears to the Court needlessly offensive in form.""")

add_sec("153", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Exclusion of evidence to contradict answers to questions testing veracity",
...
add_sec("154", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Question by party to his own witness",
...
add_sec("155", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Impeaching credit of witness",
...
add_sec("156", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Questions tending to corroborate evidence of relevant fact, admissible",
...
add_sec("157", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Former statements of witness may be proved to corroborate later testimony as to same fact",
...
add_sec("158", 10, "X", "OF THE EXAMINATION OF WITNESSES", "What matters may be proved in connection with proved statement relevant under section 32 or 33",
"""Whenever any statement, relevant under section 32 or 33, is proved, all matters may be proved either in order to contradict or to corroborate it, or in order to impeach or confirm the credit of the person by whom it was made, which might have been proved if that person had been called as a witness and had denied upon cross-examination the truth of the matter suggested.""")

add_sec("159", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Refreshing memory",
...
add_sec("160", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Testimony to facts stated in document mentioned in section 159",
...
add_sec("161", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Right of adverse party as to writing used to refresh memory",
...
add_sec("162", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Production of documents, Translation of documents",
...
add_sec("163", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Giving, as evidence, of document called for and produced on notice",
...
add_sec("164", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Using, as evidence, of document production of which was refused on notice",
...
add_sec("165", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Judge’s power to put questions or order production",
...
add_sec("166", 10, "X", "OF THE EXAMINATION OF WITNESSES", "Power of jury or assessors to put questions",
...
add_sec("167", 11, "XI", "OF IMPROPER ADMISSION AND REJECTION OF EVIDENCE", "No new trial for improper admission or rejection of evidence",
...
# Save files
project_root = "/Users/admin/Desktop/lawyer_project/backend_lawyer_project"
json_path = os.path.join(project_root, "prisma", "evidenceBearerActData.json")
js_path = os.path.join(project_root, "prisma", "evidenceBearerActData.js")

with open(json_path, "w", encoding="utf-8") as f:
    json.dump(sections, f, indent=2, ensure_ascii=False)

with open(js_path, "w", encoding="utf-8") as f:
    f.write("// THE INDIAN EVIDENCE ACT, 1872 Bearer Act Data with Full Chapter and Section Structure\n")
    f.write("export const evidenceBearerActSections = ")
    json.dump(sections, f, indent=2, ensure_ascii=False)
    f.write(";\n")

print(f"Successfully generated {len(sections)} sections across 11 chapters.")

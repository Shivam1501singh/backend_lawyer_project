...
# Complete data for THE DIGITAL PERSONAL DATA PROTECTION ACT, 2023
# Sourced solely and authoritatively from the provided PDF
...
sections_raw = [
    # CHAPTER I: PRELIMINARY
    {
        ...
        "description": "(1) This Act may be called the Digital Personal Data Protection Act, 2023.\n(2) It shall come into force on such date as the Central Government may, by notification in the Official Gazette, appoint and different dates may be appointed for different provisions of this Act and any reference in any such provision to the commencement of this Act shall be construed as a reference to the coming into force of that provision."
    },
    {
        "section": "Section 2",
        "sectionNo": "2",
    ...
    # CHAPTER III: RIGHTS AND DUTIES OF DATA PRINCIPAL
    {
        ...
        "chapterNo": 3,
        "chapterRoman": "III",
        "chapterName": "RIGHTS AND DUTIES OF DATA PRINCIPAL",
    ...
    # CHAPTER IV: SPECIAL PROVISIONS
    {
        ...
        "chapterNo": 4,
        "chapterRoman": "IV",
        "chapterName": "SPECIAL PROVISIONS",
        "title": "Processing of personal data outside India",
        "description": "(1) The Central Government may, by notification, restrict the transfer of personal data by a Data Fiduciary for processing to such country or territory outside India as may be so notified.\n(2) Nothing contained in this section shall restrict the applicability of any law for the time being in force in India that provides for a higher degree of protection for or restriction on transfer of personal data by a Data Fiduciary outside India in relation to any personal data or Data Fiduciary or class thereof."
    },
    {
        "section": "Section 17",
        "sectionNo": "17",
    ...
    },
    {
        ...
        "description": "(1) The salary, allowances and other terms and conditions of service of the Chairperson and other Members shall be such as may be prescribed, and shall not be varied to their disadvantage after their appointment.\n(2) The Chairperson and other Members shall hold office for a term of two years and shall be eligible for re-appointment."
    },
    {
        "section": "Section 21",
        "sectionNo": "21",
    ...
    },
    {
        ...
        "description": "The Board may, with previous approval of the Central Government, appoint such officers and employees as it may deem necessary for the efficient discharge of its functions under the provisions of this Act, on such terms and conditions of appointment and service as may be prescribed."
    },
    {
        "section": "Section 25",
        "sectionNo": "25",
        ...
        "description": "The Chairperson, Members, officers and employees of the Board shall be deemed, when acting or purporting to act in pursuance of provisions of this Act, to be public servants within the meaning of section 21 of the Indian Penal Code."
    },
    {
        "section": "Section 26",
        "sectionNo": "26",
    ...
    },
    {
        ...
        "description": "All sums realised by way of penalties imposed by the Board under this Act, shall be credited to the Consolidated Fund of India."
    },
    ...
    # CHAPTER IX: MISCELLANEOUS
    {
        ...
        "description": "No suit, prosecution or other legal proceedings shall lie against the Central Government, the Board, its Chairperson and any Member, officer or employee thereof for anything which is done or intended to be done in good faith under the provisions of this Act or the rules made thereunder."
    },
    {
        "section": "Section 36",
        "sectionNo": "36",
        ...
        "description": "The Central Government may, for the purposes of this Act, require the Board and any Data Fiduciary or intermediary to furnish such information as it may call for."
    },
    {
        "section": "Section 37",
        "sectionNo": "37",
    ...
    },
    {
        ...
        "description": "No civil court shall have the jurisdiction to entertain any suit or proceeding in respect of any matter for which the Board is empowered under the provisions of this Act and no injunction shall be granted by any court or other authority in respect of any action taken or to be taken in pursuance of any power under the provisions of this Act."
    },
    {
        "section": "Section 40",
        "sectionNo": "40",
    ...
    },
    {
        ...
        "description": "(1) The Central Government may, by notification, amend the Schedule, subject to the restriction that no such notification shall have the effect of increasing any penalty specified therein to more than twice of what was specified in it when this Act was originally enacted.\n(2) Any amendment notified under sub-section (1) shall have effect as if enacted in this Act and shall come into force on the date of the notification."
    },
    {
        "section": "Section 43",
        "sectionNo": "43",
...
print(f"Total DPDP sections generated: {len(dataset)}")

# Write json
json_path = os.path.join(os.path.dirname(__file__), "../prisma/dpdpBearerActData.json")
with open(json_path, "w", encoding="utf-8") as f:
    json.dump(dataset, f, indent=2, ensure_ascii=False)

# Write js
js_path = os.path.join(os.path.dirname(__file__), "../prisma/dpdpBearerActData.js")
with open(js_path, "w", encoding="utf-8") as f:
    f.write("export const dpdpBearerActSections = ")
    json.dump(dataset, f, indent=2, ensure_ascii=False)
    f.write(";\n")

#!/usr/bin/env python3
"""
Generates prisma/ndpsBearerActData.json and prisma/ndpsBearerActData.js
containing all 129 sections across 8 chapters of
THE NARCOTIC DRUGS AND PSYCHOTROPIC SUBSTANCES ACT, 1985
from the attached PDF source of truth.
"""
import json
import os

ACT_HEADING = "THE NARCOTIC DRUGS AND PSYCHOTROPIC SUBSTANCES ACT, 1985"
...
Provided that the Central Government may, having regard to the developments in the field of methods of calculating percentages in liquid preparations prescribe, by rules, any other basis which it may deem appropriate for such calculation.""",
        "metaData": "Chapter I PRELIMINARY",
        "metaDescription": f"{ACT_HEADING} Section 2 - Definitions",
    ...
    },
    {
        ...
        "chapterRoman": "I",
        "chapterName": "PRELIMINARY",
        "title": "Power to add to or omit from the list of psychotropic substances",
        "description": """The Central Government may, if satisfied that it is necessary or expedient so to do on the basis of—
...
by notification in the Official Gazette, add to, or, as the case may be, omit from, the list of psychotropic substances specified in the Schedule such substance or natural material or salt or preparation of such substance or material.""",
        "metaData": "Chapter I PRELIMINARY",
        "metaDescription": f"{ACT_HEADING} Section 3 - Power to add to or omit from the list of psychotropic substances",
    ...
    # ==========================================
    {
        ...
        "chapterNo": 2,
        "chapterRoman": "II",
        "chapterName": "AUTHORITIES AND OFFICERS",
...
(3) The Central Government may, if it considers it necessary or expedient so to do for the purposes of this Act, by order, published in the Official Gazette, constitute an authority or a hierarchy of authorities by such name or names as may be specified in the order for the purpose of exercising such of the powers and functions of the Central Government under this Act and for taking measures with respect to such of the matters referred to in sub-section (2) as may be mentioned in the order, and subject to the supervision and control of the Central Government and the provisions of such order, such authority or authorities may exercise the powers and take the measures so mentioned in the order as if such authority or authorities had been empowered by this Act to exercise those powers and take such measures.""",
        "metaData": "Chapter II AUTHORITIES AND OFFICERS",
        "metaDescription": f"{ACT_HEADING} Section 4 - Central Government to take measures for preventing and combating abuse of and illicit traffic in narcotic drugs, etc.",
    ...
    },
    {
        ...
        "chapterRoman": "II",
        "chapterName": "AUTHORITIES AND OFFICERS",
        "title": "Officers of Central Government",
        "description": """(1) Without prejudice to the provisions of sub-section (3) of section 4, the Central Government shall appoint a Narcotics Commissioner and may also appoint such other officers with such designations as it thinks fit for the purposes of this Act.
...
(3) The officers appointed under sub-section (1) shall be subject to the general control and direction of the Central Government, or, if so directed by that Government, also of the Board or any other authority or officer.""",
        "metaData": "Chapter II AUTHORITIES AND OFFICERS",
        "metaDescription": f"{ACT_HEADING} Section 5 - Officers of Central Government",
    ...
    },
    {
        ...
        "chapterRoman": "II",
        "chapterName": "AUTHORITIES AND OFFICERS",
        "title": "The Narcotic Drugs and Psychotropie Substances Consultative Committee",
        "description": """(1) The Central Government may constitute, by notification in the Official Gazette, an advisory committee to be called “The Narcotic Drugs and Psychotropic Substances Consultative Committee” (hereafter in this section referred to as the Committee) to advise the Central Government on such matters relating to the administration of this Act as are referred to it by that Government from time to time.
...
(5) The term of office of, the manner of filling casual vacancies in the offices of and the allowances, if any, payable to, the Chairman and other members of the Committee, and the conditions and restrictions subject to which the Committee may appoint a person who is not a member of the Committee as a member of any of its sub-committees, shall be such as may be prescribed by rules made by the Central Government.""",
        "metaData": "Chapter II AUTHORITIES AND OFFICERS",
        "metaDescription": f"{ACT_HEADING} Section 6 - The Narcotic Drugs and Psychotropie Substances Consultative Committee",
    ...
    },
    {
        ...
        "chapterRoman": "II",
        "chapterName": "AUTHORITIES AND OFFICERS",
        "title": "Officers of State Government",
        "description": """(1) The State Government may appoint such officers with such designations as it thinks fit for the purposes of this Act.
(2) The officers appointed under sub-section (1) shall be subject to the general control and direction of the State Government, or, if so directed by that Government, also of any other authority or officer.""",
        "metaData": "Chapter II AUTHORITIES AND OFFICERS",
        "metaDescription": f"{ACT_HEADING} Section 7 - Officers of State Government",
    ...
    # ==========================================
    {
        ...
        "chapterNo": 3,
        "chapterRoman": "IIA",
        "chapterName": "NATIONAL FUND FOR CONTROL OF DRUG ABUSE",
        "title": "National Fund for Control of Drug Abuse",
        "description": """(1) The Central Government may, by notification in the Official Gazette, constitute a Fund to be called the National Fund for Control of Drug Abuse (hereafter in this Chapter referred to as the Fund) and there shall be credited thereto—
...
(5) The Governing Body shall have the power to regulate its own procedure.""",
        "metaData": "Chapter IIA NATIONAL FUND FOR CONTROL OF DRUG ABUSE",
        "metaDescription": f"{ACT_HEADING} Section 7A - National Fund for Control of Drug Abuse",
        "metaTitle": f"Section 7A - {ACT_HEADING}"
    },
    {
        "section": "Section 7B",
        "sectionNo": "7B",
        ...
        "chapterRoman": "IIA",
        "chapterName": "NATIONAL FUND FOR CONTROL OF DRUG ABUSE",
        "title": "Annual report of activities financed under the Fund",
        "description": "The Central Government shall, as soon as may be, after the end of each financial year, cause to be published in the Official Gazette, a report giving an account of the activities financed under section 7A during the financial year, together with a statement of accounts.",
        "metaData": "Chapter IIA NATIONAL FUND FOR CONTROL OF DRUG ABUSE",
        "metaDescription": f"{ACT_HEADING} Section 7B - Annual report of activities financed under the Fund",
        "metaTitle": f"Section 7B - {ACT_HEADING}"
    },
    ...
    # ==========================================
    {
        ...
        "chapterNo": 4,
        "chapterRoman": "III",
        "chapterName": "PROHIBITION, CONTROL AND REGULATION",
...
Provided further that nothing in this section shall apply to the export of poppy straw for decorative purposes.""",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 8 - Prohibition of certain operations",
...
(c) knowingly acquire, possess or use any property which was derived from an offence committed under this Act or under any other corresponding law of any other country.""",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 8A - Prohibition of certain activities relating to property derived from offence",
    ...
    },
    {
        ...
        "chapterRoman": "III",
        "chapterName": "PROHIBITION, CONTROL AND REGULATION",
        "title": "Power of Central Government to permit, control and regulate",
        "description": """(1) Subject to the provisions of section 8, the Central Government may, by rules—
...
(j) prescribe the ports and other places at which any kind of narcotic drugs or psychotropic substances may be imported into India or exported from India or transhipped; the forms and conditions of certificates, authorisations or permits, as the case may be, for such import, export or transhipment; the authorities by which such certificates, authorisations or permits may be granted and the fees that may be charged therefor.""",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 9 - Power of Central Government to permit, control and regulate",
...
(2) Without prejudice to the generality of the power conferred by sub-section (1), an order made thereunder may provide for regulating by licences, permits or otherwise, the production, manufacture, possession, transport, import inter-State, export inter-State, sale, purchase, consumption, use, storage, distribution, disposal or acquisition of any controlled substance.""",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 9A - Power to control and regulate controlled substances",
        "metaTitle": f"Section 9A - {ACT_HEADING}"
    },
    {
        "section": "Section 10",
        "sectionNo": "10",
        ...
        "chapterRoman": "III",
        "chapterName": "PROHIBITION, CONTROL AND REGULATION",
        "title": "Power of State Government to permit, control and regulate",
        "description": """(1) Subject to the provisions of section 8, the State Government may, by rules—
(a) permit and regulate—
...
(f) prescribe the forms and conditions of licences or permits for the purposes specified in sub-clauses (i) to (vi) of clause (a) of sub-section (1) and the authorities by which such licences or permits may be granted and the fees that may be charged therefor.""",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 10 - Power of State Government to permit, control and regulate",
    ...
    },
    {
        ...
        "chapterRoman": "III",
        "chapterName": "PROHIBITION, CONTROL AND REGULATION",
        "title": "Narcotic drugs and psychotropic substances, etc., not liable to distress or attachment",
        "description": "Notwithstanding anything to the contrary contained in any law or contract, no narcotic drug, psychotropic substance, coca plant, the opium poppy or cannabis plant shall be liable to be distrained or attached by any person for the recovery of any money under any order or decree of any court or authority or otherwise.",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 11 - Narcotic drugs and psychotropic substances, etc., not liable to distress or attachment",
        "metaTitle": f"Section 11 - {ACT_HEADING}"
    },
    {
        "section": "Section 12",
        "sectionNo": "12",
        ...
        "chapterRoman": "III",
        "chapterName": "PROHIBITION, CONTROL AND REGULATION",
        "title": "Restrictions over external dealings in narcotic drugs and psychotropic substances",
        "description": "No person shall engage in or control any trade whereby a narcotic drug or psychotropic substance is obtained outside India and supplied to any person outside India save with the previous authorisation of the Central Government and subject to such conditions as may be imposed by that Government in this behalf.",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 12 - Restrictions over external dealings in narcotic drugs and psychotropic substances",
        "metaTitle": f"Section 12 - {ACT_HEADING}"
    },
    {
        "section": "Section 13",
        "sectionNo": "13",
        ...
        "description": "Notwithstanding anything contained in section 8, the Central Government may permit, with or without conditions, and on behalf of Government, the cultivation of any coca plant or gathering of any portion thereof or the production, possession, sale, purchase, transport, import inter-State, export inter-State or import into India of coca leaves for use in the preparation of any flavouring agent which shall not contain any alkaloid and to the extent necessary for such use.",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 13 - Special provisions relating to coca plant and coca leaves for use in the preparation of flavouring agent",
        "metaTitle": f"Section 13 - {ACT_HEADING}"
    },
    {
        "section": "Section 14",
        "sectionNo": "14",
        ...
        "chapterRoman": "III",
        "chapterName": "PROHIBITION, CONTROL AND REGULATION",
        "title": "Special provision relating to cannabis",
        "description": "Notwithstanding anything contained in section 8, Government may, by general or special order and subject to such conditions as may be specified in such order, allow cultivation of any cannabis plant for industrial purposes only of obtaining fibre or seed or for horticultural purposes.",
        "metaData": "Chapter III PROHIBITION, CONTROL AND REGULATION",
        "metaDescription": f"{ACT_HEADING} Section 14 - Special provision relating to cannabis",
        "metaTitle": f"Section 14 - {ACT_HEADING}"
    },
    ...
    # ==========================================
    {
        ...
        "description": """Whoever, in contravention of any provisions of this Act or any rule or order made or condition of a licence granted thereunder, produces, possesses, transports, imports inter-State, exports inter-State, sells, purchases, uses or omits to warehouse poppy straw or removes or does any act in respect of warehoused poppy straw shall be punishable,—
...
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 15 - Punishment for contravention in relation to poppy straw",
        "metaTitle": f"Section 15 - {ACT_HEADING}"
    },
    {
        "section": "Section 16",
        "sectionNo": "16",
        ...
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 16 - Punishment for contravention in relation to coca plant and coca leaves",
        "metaTitle": f"Section 16 - {ACT_HEADING}"
    },
    {
        "section": "Section 17",
        "sectionNo": "17",
        ...
        "description": """Whoever, in contravention of any provision of this Act or any rule or order made or condition of licence granted thereunder, manufactures, possesses, sells, purchases, transports, imports inter-State, exports inter-State or uses prepared opium shall be punishable,—
...
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 17 - Punishment for contravention in relation to prepared opium",
        "metaTitle": f"Section 17 - {ACT_HEADING}"
    },
    {
        "section": "Section 18",
        "sectionNo": "18",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Punishment for contravention in relation to opium poppy and opium",
        "description": """Whoever, in contravention of any provision of this Act or any rule or order made or condition of licence granted thereunder, cultivates the opium poppy or produces, manufactures, possesses, sells, purchases, transports, imports inter-State, exports inter-State or uses opium shall be punishable,—
(a) where the contravention involves small quantity, with rigorous imprisonment for a term which may extend to one year, or with fine which may extend to ten thousand rupees, or with both;
...
(c) in any other case, with rigorous imprisonment which may extend to ten years and with fine which may extend to one lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 18 - Punishment for contravention in relation to opium poppy and opium",
        "metaTitle": f"Section 18 - {ACT_HEADING}"
    },
    {
        "section": "Section 19",
        "sectionNo": "19",
        ...
        "description": """Any cultivator licensed to cultivate the opium poppy on account of the Central Government who embezzles or otherwise illegally disposes of the opium produced or any part thereof, shall be punishable with rigorous imprisonment for a term which shall not be less than ten years but which may extend to twenty years and shall also be liable to fine which shall not be less than one lakh rupees but which may extend to two lakh rupees:
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 19 - Punishment for embezzlement of opium by cultivator",
        "metaTitle": f"Section 19 - {ACT_HEADING}"
    },
    {
        "section": "Section 20",
        "sectionNo": "20",
        ...
        "description": """Whoever, in contravention of any provision of this Act or any rule or order made or condition of licence granted thereunder,—
...
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 20 - Punishment for contravention in relation to cannabis plant and cannabis",
        "metaTitle": f"Section 20 - {ACT_HEADING}"
    },
    {
        "section": "Section 21",
        "sectionNo": "21",
...
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 21 - Punishment for contravention in relation to manufactured drugs and preparations",
        "metaTitle": f"Section 21 - {ACT_HEADING}"
    },
    {
        "section": "Section 22",
        "sectionNo": "22",
        ...
        "description": """Whoever, in contravention of any provision of this Act or any rule or order made or condition of licence granted thereunder, manufactures, possesses, sells, purchases, transports, imports inter-State, exports inter-State or uses any psychotropic substance shall be punishable,—
(a) where the contravention involves small quantity, with rigorous imprisonment for a term which may extend to one year, or with fine which may extend to ten thousand rupees, or with both;
(b) where the contravention involves quantity lesser than commercial quantity but greater than small quantity, with rigorous imprisonment for a term which may extend to ten years, and with fine which may extend to one lakh rupees;
(c) where the contravention involves commercial quantity, with rigorous imprisonment for a term which shall not be less than ten years but which may extend to twenty years, and shall also be liable to fine which shall not be less than one lakh rupees but which may extend to two lakh rupees:
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 22 - Punishment for contravention in relation to psychotropic substances",
        "metaTitle": f"Section 22 - {ACT_HEADING}"
    },
    {
        "section": "Section 23",
        "sectionNo": "23",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Punishment for illegal import into India, export from India or transhipment of narcotic drugs and psychotropic substances",
...
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 23 - Punishment for illegal import into India, export from India or transhipment of narcotic drugs and psychotropic substances",
        "metaTitle": f"Section 23 - {ACT_HEADING}"
    },
    {
        "section": "Section 24",
        "sectionNo": "24",
...
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
    ...
    },
    {
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Punishment for allowing premises, etc., to be used for commission of an offence",
        "description": "Whoever, being the owner or occupier or having the control or use of any house, room, enclosure, space, place, animal or conveyance, knowingly permits it to be used for the commission by any other person of an offence punishable under any provision of this Act, shall be punishable with the punishment provided for that offence.",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 25 - Punishment for allowing premises, etc., to be used for commission of an offence",
        "metaTitle": f"Section 25 - {ACT_HEADING}"
    },
    {
        "section": "Section 25A",
        "sectionNo": "25A",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Punishment for contravention of orders made under section 9A",
        "description": """If any person contravenes an order made under section 9A, he shall be punishable with rigorous imprisonment for a term which may extend to ten years and shall also be liable to fine which may extend to one lakh rupees:
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding one lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 25A - Punishment for contravention of orders made under section 9A",
        "metaTitle": f"Section 25A - {ACT_HEADING}"
    },
    {
        "section": "Section 26",
        "sectionNo": "26",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Punishment for certain acts by licensee or his servants",
        "description": """If the holder of any licence, permit or authorisation granted under this Act or any rule or order made thereunder or any person in his employ and acting on his behalf—
...
he shall be punishable with imprisonment for a term which may extend to three years or with fine or with both.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 26 - Punishment for certain acts by licensee or his servants",
        "metaTitle": f"Section 26 - {ACT_HEADING}"
    },
    {
        "section": "Section 27",
        "sectionNo": "27",
        ...
        "description": """Whoever, consumes any narcotic drug or psychotropic substance shall be punishable,—
...
(b) where the narcotic drug or psychotropic substance consumed is other than those specified in or under clause (a), with imprisonment for a term which may extend to six months, or with fine which may extend to ten thousand rupees, or with both.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 27 - Punishment for consumption of any narcotic drug or psychotropic substance",
        "metaTitle": f"Section 27 - {ACT_HEADING}"
    },
    {
        "section": "Section 27A",
        "sectionNo": "27A",
        ...
        "description": """Whoever indulges in financing, directly or indirectly, any, of the activities specified in sub-clauses (i) to (v) of clause (viiib) of section 2 or harbours any person engaged in any of the aforementioned activities, shall be punishable with rigorous imprisonment for a term which shall not be less than ten years but which may extend to twenty years and shall also be liable to fine which shall not be less than one lakh rupees but which may extend to two lakh rupees:
Provided that the court may, for reasons to be recorded in the judgment, impose a fine exceeding two lakh rupees.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 27A - Punishment for financing illicit traffic and harbouring offenders",
        "metaTitle": f"Section 27A - {ACT_HEADING}"
    },
    {
        "section": "Section 27B",
        "sectionNo": "27B",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Punishment for contravention of section 8A",
        "description": "Whoever contravenes the provision of section 8A shall be punishable with rigorous imprisonment for a term which shall not be less than three years but which may extend to ten years and shall also be liable to fine.",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 27B - Punishment for contravention of section 8A",
        "metaTitle": f"Section 27B - {ACT_HEADING}"
    },
    {
        "section": "Section 28",
        "sectionNo": "28",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Punishment for attempts to commit offences",
        "description": "Whoever attempts to commit any offence punishable under this Chapter or to cause such offence to be committed and in such attempt does any act towards the commission of the offence shall be punishable with the punishment provided for the offence.",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 28 - Punishment for attempts to commit offences",
        "metaTitle": f"Section 28 - {ACT_HEADING}"
    },
    {
        "section": "Section 29",
        "sectionNo": "29",
        ...
        "description": """(1) Whoever abets, or is a party to a criminal conspiracy to commit, an offence punishable under this Chapter, shall, whether such offence be or be not committed in consequence of such abetment or in pursuance of such criminal conspiracy, and notwithstanding anything contained in section 116 of the Indian Penal Code (45 of 1860), be punishable with the punishment provided for the offence.
...
(b) under the laws of such place, is an offence relating to narcotic drugs or psychotropic substances having all the legal conditions required to constitute it such an offence the same as or analogous to the legal conditions required to constitute it an offence punishable under this Chapter, if committed within India.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 29 - Punishment for abetment and criminal conspiracy",
        "metaTitle": f"Section 29 - {ACT_HEADING}"
    },
    {
        "section": "Section 30",
        "sectionNo": "30",
...
Provided that the court may, for reasons to be recorded in the Judgment, impose a higher fine.""",
    ...
    },
    {
        ...
        "description": """(1) If any person who has been convicted of the commission of, or attempt to commit, or abetment of, or criminal conspiracy to commit, any of the offences punishable under this Act is subsequently convicted of the commission of, or attempt to commit, or abetment of, or criminal conspiracy to commit, an offence punishable under this Act with the same amount of punishment shall be punished for the second and every subsequent offence with rigorous imprisonment for a term which may extend to one and one-half times of the maximum term of imprisonment, and also be liable to fine which shall extend to one and one-half times of the maximum amount of fine.
...
(3) Where any person is convicted by a competent court of criminal jurisdiction outside India under any corresponding law, such person, in respect of such conviction, shall be dealt with for the purposes of sub-sections (1) and (2) as if he had been convicted by a court in India.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 31 - Enhanced punishment for offences after previous conviction",
        "metaTitle": f"Section 31 - {ACT_HEADING}"
    },
    {
        "section": "Section 31A",
        "sectionNo": "31A",
        ...
        "description": """(1) Notwithstanding anything contained in section 31, if any person who has been convicted of the commission of, or attempt to commit, or abetment of, or criminal conspiracy to commit, any of the offences punishable under section 19, section 24, section 27A and for offences involving commercial quantity of any narcotic drug or psychotropic substance, is subsequently convicted of the commission of, or attempt to commit, or abetment of, or criminal conspiracy to commit, an offence relating to,—
...
TABLE
Particulars of narcotic drugs/psychotropic substances (1) | Quantity (2)
(i) Opium: 10 kgs.
(ii) Morphine: 1 kg.
(iii) Heroin: 1 kg.
(iv) Codeine: 1 kg.
...
(2) Where any person is convicted by a competent court of criminal jurisdiction outside India under any law corresponding to the provisions of section 19, section 24 or section 27A and for offences involving commercial quality of any narcotic drug or psychotropic substance, such person, in respect of such conviction, shall be dealt with for the purposes of sub-section (1) as if he had been convicted by a court in India.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 31A - Death penalty for certain offences after previous conviction",
        "metaTitle": f"Section 31A - {ACT_HEADING}"
    },
    {
        "section": "Section 32",
        "sectionNo": "32",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Punishment for offence for which no punishment is provided",
        ...
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 32 - Punishment for offence for which no punishment is provided",
        "metaTitle": f"Section 32 - {ACT_HEADING}"
    },
    {
        "section": "Section 32A",
        "sectionNo": "32A",
        ...
        "description": "Notwithstanding anything contained in the Code of Criminal Procedure, 1973 (2 of 1974), or any other law for the time being in force but subject to the provisions of section 33, no sentence awarded under this Act (other than section 27) shall be suspended or remitted or commuted.",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 32A - No suspension, remission or commutation in any sentence awarded under this Act",
        "metaTitle": f"Section 32A - {ACT_HEADING}"
    },
    {
        "section": "Section 32B",
        "sectionNo": "32B",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Factors to be taken into account for imposing higher than the minimum punishment",
        "description": """Where a minimum term of imprisonment or amount of fine is prescribed for any offence committed under this Act, the court may, in addition to such factors as it may deem fit, take into account the following factors for imposing a punishment higher than the minimum term of imprisonment or amount of fine, namely:—
...
(f) the fact that the offender is involved in other illegal activities facilitated by commission of the offence.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 32B - Factors to be taken into account for imposing higher than the minimum punishment",
        "metaTitle": f"Section 32B - {ACT_HEADING}"
    },
    {
        "section": "Section 33",
        "sectionNo": "33",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Application of section 360 of the Code of Criminal Procedure, 1973 and of the Probation of Offenders Act, 1958",
        "description": "Nothing contained in section 360 of the Code of Criminal Procedure, 1973 (2 of 1974) or in the Probation of Offenders Act, 1958 (20 of 1958) shall apply to a person convicted of an offence under this Act unless such person is under eighteen years of age or that the offence for which such person is convicted is punishable under section 26 or section 27.",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 33 - Application of section 360 of the Code of Criminal Procedure, 1973 and of the Probation of Offenders Act, 1958",
        "metaTitle": f"Section 33 - {ACT_HEADING}"
    },
    {
        "section": "Section 34",
        "sectionNo": "34",
...
(4) An order under this section may also be made by an appellate court or by the High Court or Sessions Judge when exercising the powers of revision.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 34 - Security for abstaining from commission of offence",
        "metaTitle": f"Section 34 - {ACT_HEADING}"
    },
    {
        "section": "Section 35",
        "sectionNo": "35",
        ...
        "description": """(1) In any prosecution for an offence under this Act which requires a culpable mental state of the accused, the court shall presume the existence of such mental state but it shall be a defence for the accused to prove the fact that he had no such mental state with respect to the act charged as an offence in that prosecution.
Explanation.—In this section “culpable mental state” includes intention motive, knowledge of a fact and belief in, or reason to believe, a fact.
(2) For the purpose of this section, a fact is said to be proved only when the court believes it to exist beyond a reasonable doubt and not merely when its existence is established by a preponderance of probability.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 35 - Presumption of culpable mental state",
        "metaTitle": f"Section 35 - {ACT_HEADING}"
    },
    {
        "section": "Section 36",
        "sectionNo": "36",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Constitution of Special Court",
        "description": """(1) The Government may, for the purpose of providing speedy trial of the offences under this Act, by notification in the Official Gazette, constitute as many Special Court as may be necessary for such area or areas as may be specified in the notification.
...
(3) A person shall not be qualified for appointment as a Judge of a Special Court unless he is, immediately before such appointment, a Sessions Judge or an Additional Sessions Judge.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 36 - Constitution of Special Court",
        "metaTitle": f"Section 36 - {ACT_HEADING}"
    },
    {
        "section": "Section 36A",
        "sectionNo": "36A",
...
(5) Notwithstanding anything contained in the Code of Criminal Procedure, 1973 (2 of 1974), the offences punishable under this Act with imprisonment for a term of not more than three years may be tried summarily.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 36A - Offences triable by Special Courts",
        "metaTitle": f"Section 36A - {ACT_HEADING}"
    },
    {
        "section": "Section 36B",
        "sectionNo": "36B",
        ...
        "description": "The High Court may exercise, so for as may be applicable, all the powers conferred by Chapters XXIX and XXX of the Code of Criminal Procedure, 1973 (2 of 1974) on a High Court, as if a Special Court within the local limits of the jurisdiction of the High Court were a Court of Session trying cases within the local limits of the jurisdiction of the High Court.",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 36B - Appeal and revision",
        "metaTitle": f"Section 36B - {ACT_HEADING}"
    },
    {
        "section": "Section 36C",
        "sectionNo": "36C",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Application of Code to proceedings before a Special Court",
        "description": "Save as otherwise provided in this Act, the provisions of the Code of Criminal Procedure, 1973 (2 of 1974), (including the provisions as to bail and bonds) shall apply to the proceedings before a Special Court and for the purposes of the said provisions, the Special Court shall be deemed to be a Court of Session and the person conducting a prosecution before a Special Court, shall be deemed to be a Public Prosecutor.",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 36C - Application of Code to proceedings before a Special Court",
        "metaTitle": f"Section 36C - {ACT_HEADING}"
    },
    {
        "section": "Section 36D",
        "sectionNo": "36D",
...
Provided that nothing contained in this sub-section shall affect the power of the High Court under section 407 of the Code of Criminal Procedure, 1973 (2 of 1974) to transfer any case or class of cases taken cognizance by a Court of Session under sub-section (1).""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 36D - Transitional provisions",
        "metaTitle": f"Section 36D - {ACT_HEADING}"
    },
    {
        "section": "Section 37",
        "sectionNo": "37",
...
(2) The limitations on granting of bail specified in clause (b) of sub-section (1) are in addition to the limitations under the Code of Criminal Procedure, 1973 (2 of 1974) or any other law for the time being in force on granting of bail.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 37 - Offences to be cognizable and non-bailable",
        "metaTitle": f"Section 37 - {ACT_HEADING}"
    },
    {
        "section": "Section 38",
        "sectionNo": "38",
...
(b) “director”, in relation to a firm, means a partner in the firm.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 38 - Offences by companies",
        "metaTitle": f"Section 38 - {ACT_HEADING}"
    },
    {
        "section": "Section 39",
        "sectionNo": "39",
...
(2) If it appears to the court, having regard to the report regarding the result of the medical treatment furnished under sub-section (1), that it is expedient so to do, the court may direct the release of the offender after due admonition on his entering into a bond in the form prescribed by the Central Government, with or without sureties, for abstaining from the commission of any offence under Chapter IV during such period not exceeding three years as the court may deem fit to specify or on his failure so to abstain, to appear before the court and receive sentence when called upon during such period.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 39 - Power of court to release certain offenders on probation",
        "metaTitle": f"Section 39 - {ACT_HEADING}"
    },
    {
        "section": "Section 40",
        "sectionNo": "40",
        ...
        "chapterRoman": "IV",
        "chapterName": "OFFENCES AND PENALTIES",
        "title": "Power of court to publish names, place of business, etc., of certain offenders",
...
(3) The expenses of any publication under sub-section (1) shall be recoverable from the convicted person as if it were a fine imposed by the court.""",
        "metaData": "Chapter IV OFFENCES AND PENALTIES",
        "metaDescription": f"{ACT_HEADING} Section 40 - Power of court to publish names, place of business, etc., of certain offenders",
        "metaTitle": f"Section 40 - {ACT_HEADING}"
    },
...
(3) The officer to whom a warrant under sub-section (1) is addressed and the officer who authorised the arrest or search or the officer who is so authorised under sub-section (2) shall have all the powers of an officer acting under section 42.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 41 - Power to issue warrant and authorisation",
        "metaTitle": f"Section 41 - {ACT_HEADING}"
    },
    {
        "section": "Section 42",
        "sectionNo": "42",
...
(2) Where an officer takes down any information in writing under sub-section (1) or records grounds for his belief under the proviso thereto, he shall within seventy-two hours send a copy thereof to his immediate official superior.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 42 - Power of entry, search, seizure and arrest without warrant or authorisation",
        "metaTitle": f"Section 42 - {ACT_HEADING}"
    },
    {
        "section": "Section 43",
        "sectionNo": "43",
        ...
        "description": """Any officer of any of the departments mentioned in section 42 may—
...
Explanation.—For the purposes of this section, the expression “public place” includes any public conveyance, hotel, shop, or other place intended for use by, or accessible to, the public.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 43 - Power of seizure and arrest in public place",
        "metaTitle": f"Section 43 - {ACT_HEADING}"
    },
    {
        "section": "Section 44",
        "sectionNo": "44",
        ...
        "description": "The provisions of sections 41, 42 and 43, shall so far as may be, apply in relation to the offence punishable under Chapter IV and relating to coca plant, the opium poppy or cannabis plant and for this purpose references in those sections to narcotic drugs, or psychotropic substance or controlled substance, shall be construed as including references to coca plant, the opium poppy and cannabis plant.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 44 - Power of entry, search, seizure and arrest in offences relating to coca plant, opium poppy and cannabis plant",
        "metaTitle": f"Section 44 - {ACT_HEADING}"
    },
    {
        "section": "Section 45",
        "sectionNo": "45",
    ...
    },
    {
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Duty of land holder to give information of illegal cultivation",
        "description": "Every holder of land shall give immediate information to any officer of the Police or of any of the departments mentioned in section 42 of all the opium poppy, cannabis plant or coca plant which may be illegally cultivated within his land and every such holder of land who knowingly neglects to give such information, shall be liable to punishment.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 46 - Duty of land holder to give information of illegal cultivation",
        "metaTitle": f"Section 46 - {ACT_HEADING}"
    },
    {
        "section": "Section 47",
        "sectionNo": "47",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Duty of certain officers to give information of illegal cultivation",
        "description": "Every officer of the Government and every panch, sarpanch and other village officer of whatever description shall give immediate information to any officer of the Police or of any of the departments mentioned in section 42 when it may come to his knowledge that any land has been illegally cultivated with the opium poppy, cannabis plant or coca plant, and every such officer of the Government, panch, sarpanch and other village officer who neglects to give such information shall be liable to punishment.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 47 - Duty of certain officers to give information of illegal cultivation",
        "metaTitle": f"Section 47 - {ACT_HEADING}"
    },
    {
        "section": "Section 48",
        "sectionNo": "48",
...
(c) if it becomes necessary to stop the animal or the conveyance, he may use all lawful means for stopping it, and where such means fail, the animal or the conveyance may be fired upon.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 49 - Power to stop and search conveyance",
        "metaTitle": f"Section 49 - {ACT_HEADING}"
    },
    {
        "section": "Section 50",
        "sectionNo": "50",
        ...
        "description": """(1) When any officer duly authorised under section 42 is about to search any person under the provisions of section 41, section 42 or section 43, he shall, if such person so requires, take such person without unnecessary delay to nearest Gazetted Officer of any of the departments mentioned in section 42 or to the nearest Magistrate.
...
(6) After a search is conducted under sub-section (5), the officer shall record the reasons for such belief which necessitated such search and within seventy-two hours send a copy thereof to his immediate official superior.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 50 - Conditions under which search of persons shall be conducted",
        "metaTitle": f"Section 50 - {ACT_HEADING}"
    },
    {
        "section": "Section 50A",
        "sectionNo": "50A",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Power to undertake controlled delivery",
        "description": """The Director General of Narcotics Control Bureau constituted under sub-section (3) of section 4 or any other officer authorised by him in this behalf, may, notwithstanding anything contained in this Act, undertake controlled delivery of any consignment to—
...
(b) a foreign country, in consultation with the competent authority of such foreign country to which such consignment is destined, in such manner as may be prescribed.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 50A - Power to undertake controlled delivery",
        "metaTitle": f"Section 50A - {ACT_HEADING}"
    },
    {
        "section": "Section 51",
        "sectionNo": "51",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Provisions of the code of Criminal Procedure, 1973 to apply to warrants, arrests, searches and seizures",
        "description": "The provisions of the Code of Criminal Procedure, 1973 (2 of 1974) shall apply, in so far as they are not inconsistent with the provisions of this Act, to all warrants issued and arrests, searches and seizures made under this Act.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 51 - Provisions of the code of Criminal Procedure, 1973 to apply to warrants, arrests, searches and seizures",
        "metaTitle": f"Section 51 - {ACT_HEADING}"
    },
    {
        "section": "Section 52",
        "sectionNo": "52",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Disposal of persons arrested and articles seized",
        "description": """(1) Any officer arresting a person under section 41, section 42, section 43 or section 44 shall, as soon as may be, inform him of the grounds for such arrest.
...
(4) The authority or officer to whom any person or article is forwarded under sub-section (2) or sub-section (3) shall, with all convenient despatch, take such measures as may be necessary for the disposal according to law of such person or article.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 52 - Disposal of persons arrested and articles seized",
        "metaTitle": f"Section 52 - {ACT_HEADING}"
    },
    {
        "section": "Section 52A",
        "sectionNo": "52A",
        ...
        "description": """(1) The Central Government may, having regard to the hazardous nature, vulnerability to theft, substitution, constraint of proper storage space or any other relevant consideration, in respect of any narcotic drugs, psychotropic substances, controlled substances or conveyances, by notification in the Official Gazette, specify such narcotic drugs, psychotropic substances, controlled substances or conveyance or class of narcotic drugs, class of psychotropic substances, class of controlled substances or conveyances, which shall, as soon as may be after their seizure, be disposed of by such officer and in such manner as that Government may, from time to time, determine after following the procedure hereinafter specified.
...
(4) Notwithstanding anything contained in the Indian Evidence Act, 1872 (1 of 1972) or the Code of Criminal Procedure, 1973 (2 of 1974), every court trying an offence under this Act, shall treat the inventory, the photographs of narcotic drugs, psychotropic substances, controlled substances or conveyances and any list of samples drawn under sub-section (2) and certified by the Magistrate, as primary evidence in respect of such offence.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 52A - Disposal of seized narcotic drugs and psychotropic substances",
        "metaTitle": f"Section 52A - {ACT_HEADING}"
    },
    {
        "section": "Section 53",
        "sectionNo": "53",
...
(2) The State Government may, by notification published in the Official Gazette, invest any officer of the department of drugs control, revenue or excise or any other department or any class of such officers with the powers of an officer-in-charge of a police station for the investigation of offences under this Act.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 53 - Power to invest officers of certain departments with powers of an officer-in-charge of a police station",
        "metaTitle": f"Section 53 - {ACT_HEADING}"
    },
    {
        "section": "Section 53A",
        "sectionNo": "53A",
...
(2) The provisions of sub-section (1) shall, so far as may be, apply in relation to any proceedings under this Act or the rules or orders made thereunder, other than a proceeding before a court, as they apply in relation to a proceeding before a court.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 53A - Relevancy of statements under certain circumstances",
        "metaTitle": f"Section 53A - {ACT_HEADING}"
    },
    {
        "section": "Section 54",
        "sectionNo": "54",
        ...
        "description": """In trials under this Act, it may be presumed, unless and until the contrary is proved, that the accused has committed an offence under this Act in respect of—
...
for the possession of which he fails to account satisfactorily.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 54 - Presumption from possession of illicit articles",
        "metaTitle": f"Section 54 - {ACT_HEADING}"
    },
    {
        "section": "Section 55",
        "sectionNo": "55",
        ...
        "description": "An officer-in-charge of a police station shall take charge of and keep in safe custody, pending the orders of the Magistrate, all articles seized under this Act within the local area of that police station and which may be delivered to him, and shall allow any officer who may accompany such articles to the police station or who may be deputed for the purpose, to affix his seal to such articles or to take samples of and from them and all samples so taken shall also be sealed with a seal of the officer-in-charge of the police station.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 55 - Police to take charge of articles seized and delivered",
        "metaTitle": f"Section 55 - {ACT_HEADING}"
    },
    {
        "section": "Section 56",
        "sectionNo": "56",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Obligation of officers to assist each other",
        "description": "All officers of the several departments mentioned in section 42 shall, upon notice given or request made, be legally bound to assist each other in carrying out the provisions of this Act.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 56 - Obligation of officers to assist each other",
        "metaTitle": f"Section 56 - {ACT_HEADING}"
    },
    {
        "section": "Section 57",
        "sectionNo": "57",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Report of arrest and seizure",
        "description": "Whenever any person makes any arrest or seizure under this Act, he shall, within forty-eight hours next after such arrest or seizure, make a full report of all the particulars of such arrest or seizure to his immediate official superior.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 57 - Report of arrest and seizure",
        "metaTitle": f"Section 57 - {ACT_HEADING}"
    },
    {
        "section": "Section 57A",
        "sectionNo": "57A",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Report of seizure of property of the person arrested by the notified officer",
        "description": "Whenever any officer notified under section 53 makes an arrest or seizure under this Act, and the provisions of Chapter VA apply to any person involved in the case of such arrest or seizure, the officer shall make a report of the illegally acquired properties of such person to the jurisdictional competent authority within ninety days of the arrest or seizure.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 57A - Report of seizure of property of the person arrested by the notified officer",
        "metaTitle": f"Section 57A - {ACT_HEADING}"
    },
    {
        "section": "Section 58",
        "sectionNo": "58",
        ...
        "description": """(1) Any person empowered under section 42 or section 43 or section 44 who—
...
(2) Any person wilfully and maliciously giving false information and so causing an arrest or a search being made under this Act shall be punishable with imprisonment for a term which may extend to two years or with fine or with both.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 58 - Punishment for vexatious entry, search, seizure or arrest",
        "metaTitle": f"Section 58 - {ACT_HEADING}"
    },
    {
        "section": "Section 59",
        "sectionNo": "59",
        ...
        "description": """(1) Any officer, on whom any duty has been imposed by or under this Act and who ceases or refuses to perform or withdraws himself from the duties of his office shall, unless he has obtained the express written permission of his official superior or has other lawful excuse for so doing, be punishable with imprisonment for a term which may extend to one year or with fine or with both.
...
(3) No court shall take cognizance of any offence under sub-section (1) or sub-section (2) except on a complaint in writing made with the previous sanction of the Central Government, or as the case may be, the State Government.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 59 - Failure of officer in duty or his connivance at the contravention of the provisions of this Act",
        "metaTitle": f"Section 59 - {ACT_HEADING}"
    },
    {
        "section": "Section 60",
        "sectionNo": "60",
...
(3) Any animal or conveyance used in carrying any narcotic drug or psychotropic substance or controlled substances, or any article liable to confiscation under sub-section (1) or sub-section (2) shall be liable to confiscation, unless the owner of the animal or conveyance proves that it was so used without the knowledge or connivance of the owner himself, his agent, if any, and the person-in-charge of the animal or conveyance and that each of them had taken all reasonable precautions against such use.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 60 - Liability of illicit drugs, substances, plants, articles and conveyances to confiscation",
        "metaTitle": f"Section 60 - {ACT_HEADING}"
    },
    {
        "section": "Section 61",
        "sectionNo": "61",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Confiscation of goods used for concealing illicit drugs or substances",
        "description": """Any goods used for concealing any narcotic drug, psychotropic substance or controlled substance which is liable to confiscation under this Act shall also be liable to confiscation.
Explanation.—In this section “goods” does not include conveyance as a means of transport.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 61 - Confiscation of goods used for concealing illicit drugs or substances",
        "metaTitle": f"Section 61 - {ACT_HEADING}"
    },
    {
        "section": "Section 62",
        "sectionNo": "62",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Confiscation of sale proceeds of illicit drugs or substances",
        "description": "Where any narcotic drug, psychotropic substance or controlled substance is sold by a person having knowledge or reason to believe that the drug or substance is liable to confiscation under this Act, the sale proceeds thereof shall also be liable to confiscation.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 62 - Confiscation of sale proceeds of illicit drugs or substances",
        "metaTitle": f"Section 62 - {ACT_HEADING}"
    },
    {
        "section": "Section 63",
        "sectionNo": "63",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Procedure in making confiscations",
        "description": """(1) In the trial of offences under this Act, whether the accused is convicted or acquitted or discharged, the court shall decide whether any article or thing seized under this Act is liable to confiscation under section 60 or section 61 or section 62 and, if it decides that the article is so liable, it may order confiscation accordingly.
...
Provided further that if any such article or thing, other than a narcotic drug, psychotropic substance controlled substance, the opium poppy, coca plant or cannabis plant is liable to speedy and natural decay, or if the court is of opinion that its sale would be for the benefit of its owner, it may at any time direct it to be sold; and the provisions of this sub-section shall, as nearly as may be practicable, apply to the net proceeds of the sale.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 63 - Procedure in making confiscations",
        "metaTitle": f"Section 63 - {ACT_HEADING}"
    },
    {
        "section": "Section 64",
        "sectionNo": "64",
...
(3) If it appears to the Central Government or, as the case may be, the State Government, that any person to whom immunity has been tendered under this section has not complied with the conditions on which the tender was made or is wilfully concealing anything or is giving false evidence, the Central Government or, as the case may be, the State Government, may record a finding to that effect and thereupon the immunity shall be deemed to have been withdrawn and such person may be tried for the offence in respect of which the tender of immunity was made or for any other offence of which he appears to have been guilty in connection with the same matter.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 64 - Power to tender immunity from prosecution",
        "metaTitle": f"Section 64 - {ACT_HEADING}"
    },
    {
        "section": "Section 64A",
        "sectionNo": "64A",
...
Provided that the said immunity from prosecution may be withdrawn if the addict does not undergo the complete treatment for de-addiction.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 64A - Immunity from prosecution to addicts volunteering for treatment",
        "metaTitle": f"Section 64A - {ACT_HEADING}"
    },
    {
        "section": "Section 65",
        "sectionNo": "65",
        ...
        "chapterRoman": "V",
        "chapterName": "PROCEDURE",
        "title": "Power to make rules regulating disposal of confiscated articles and rewards [Omitted]",
        "description": "[Power to make rules regulating disposal of confiscated articles and rewards].—Omitted by the Narcotic Drugs and Psychotropic Substances (Amendment) Act, 1989 (2 of 1989), s. 18 (w.e.f. 29-5-1989).",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 65 - Power to make rules regulating disposal of confiscated articles and rewards [Omitted]",
        "metaTitle": f"Section 65 - {ACT_HEADING}"
    },
    {
        "section": "Section 66",
        "sectionNo": "66",
        ...
        "description": """Where any document—
...
(c) examine any person acquainted with the facts and circumcontrary is proved, the truth of the contents of such document.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 66 - Presumption as to documents in certain cases",
        "metaTitle": f"Section 66 - {ACT_HEADING}"
    },
    {
        "section": "Section 67",
        "sectionNo": "67",
        ...
        "description": """Any officer referred to in section 42 who is authorised in this behalf by the Central Government or a State Government may, during the course of any enquiry in connection with the contravention of any provision of this Act,—
(a) call for information from any person for the purpose of satisfying himself whether there has been any contravention of the provisions of this Act or any rule or order made thereunder;
(b) require any person to produce or deliver any document or thing useful or relevant to the enquiry;
(c) examine any person acquainted with the facts and circumstances of the case.""",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 67 - Power to call for information, etc.",
        "metaTitle": f"Section 67 - {ACT_HEADING}"
    },
    {
        "section": "Section 68",
        "sectionNo": "68",
        ...
        "description": "No officer acting in exercise of powers vested in him under any provision of this Act or any rule or order made thereunder shall be compelled to say whence he got any information as to the commission of any offence.",
        "metaData": "Chapter V PROCEDURE",
        "metaDescription": f"{ACT_HEADING} Section 68 - Information as to commission of offences",
        "metaTitle": f"Section 68 - {ACT_HEADING}"
    },
    ...
    # ==========================================
    {
        ...
        "chapterNo": 7,
        "chapterRoman": "VA",
        "chapterName": "FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "title": "Application",
        "description": """(1) The provisions of this Chapter shall apply only to the persons specified in sub-section (2).
...
(f) any holder (hereafter in this clause referred to as the “present holder”) of any property which was at any time previously held by a person referred to in clause (a) or clause (b) or clause (c) or clause (cc); unless the present holder or, as the case may be, any one who held such property after such person and before the present holder, is or was a transferee in good faith for adequate consideration.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68A - Application",
        "metaTitle": f"Section 68A - {ACT_HEADING}"
    },
    {
        "section": "Section 68B",
        "sectionNo": "68B",
...
(a) “Appellate Tribunal” means the Appellate Tribunal referred to in section 68N;
...
(i) any property acquired by such person, whether before or after the commencement of this Chapter, wholly or partly out of or by means of any income, earnings or assets derived or obtained from or attributable to the contravention of any provisions of this Act or the equivalent value of such property; or
(ii) any property acquired by such person, whether before or after the commencement of this Chapter, for a consideration, or by any means wholly or partly traceable to any property referred to in sub-clause (i) or the income or earning from such property or the equivalent value of such property; or
(iii) any property acquired by such person, whether before or after the commencement of the Narcotic Drugs and Psychotropic Substances (Amendment) Act, 2014, wholly or partly out of or by means of any income, earnings or assets the source of which cannot be proved, or the equivalent value of such property,
and includes—
...
(h) “property” means any property or assets of every description, whether corporeal or incorporeal, movable or immovable, tangible or intangible, wherever located and includes deeds and instruments evidencing title to, or interest in, such property or assets;
(i) “relative” means—
...
(k) “trust” includes any other legal obligation.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68B - Definitions",
        "metaTitle": f"Section 68B - {ACT_HEADING}"
    },
    {
        "section": "Section 68C",
        "sectionNo": "68C",
        ...
        "description": """(1) As from the commencement of this Chapter, it shall not be lawful for any person to whom this Chapter applies to hold any illegally acquired property either by himself or through any other person on his behalf.
...
Provided that no property shall be forfeited under this Chapter if such property was acquired, by a person to whom this Act applies, before a period of six years from the date he was arrested or against whom a warrant or authorisation of arrest has been issued for the commission of an offence punishable under this Act or from the date the order or detention was issued, as the case may be.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68C - Prohibition of holding illegally acquired property",
        "metaTitle": f"Section 68C - {ACT_HEADING}"
    },
    {
        "section": "Section 68D",
        "sectionNo": "68D",
...
(2) The competent authorities shall perform their functions in respect of such persons or classes of persons as the Central Government may, by order, direct.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68D - Competent authority",
        "metaTitle": f"Section 68D - {ACT_HEADING}"
    },
    {
        "section": "Section 68E",
        "sectionNo": "68E",
        ...
        "description": """(1) Every officer empowered under section 53 and every officer-in-charge of a police station shall, or receipt of information is satisfied that any person to whom this Chapter applies holds any illegally acquired property, he may, after recording reasons for doing so, proceed to take all steps necessary for tracing and identifying such property.
...
(3) Any inquiry, investigation or survey referred to in sub-section (2) shall be carried out by an officer mentioned in sub-section (1) in accordance with such directions or guidelines as the competent authority may make or issue in this behalf.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68E - Identifying illegally acquired property",
        "metaTitle": f"Section 68E - {ACT_HEADING}"
    },
    {
        "section": "Section 68F",
        "sectionNo": "68F",
...
(d) any transaction entered into by any person with intent thereby to diminish directly or indirectly the value of his own property and to increase the value of the property of any other person.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68F - Seizure or freezing of illegally acquired property",
        "metaTitle": f"Section 68F - {ACT_HEADING}"
    },
    {
        "section": "Section 68G",
        "sectionNo": "68G",
        ...
        "description": """(1) The Central Government may, by order published in the Official Gazette, appoint as many of its officers (not below the rank of a Joint secretary to the Government) as it thinks fit, to perform the functions of an Administrator.
...
(3) The Administrator shall also take such measures, as the Central Government may direct, to dispose of the property which is forfeited to the Central Government.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68G - Management of properties seized or forfeited under this Chapter",
        "metaTitle": f"Section 68G - {ACT_HEADING}"
    },
    {
        "section": "Section 68H",
        "sectionNo": "68H",
...
(4) Where any shares in a company stand forfeited to the Central Government under this Chapter, then, the company shall, notwithstanding anything contained in the Companies Act, 1956 (1 of 1956) or the articles of association of the company, forthwith register the Central Government as the transferee of such shares.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68-I - Forfeiture of property in certain cases",
        "metaTitle": f"Section 68-I - {ACT_HEADING}"
    },
    {
        "section": "Section 68J",
        "sectionNo": "68J",
        ...
        "description": "In any proceedings under this Chapter, the burden of proving that any property specified in the notice served under section 68H is not illegally acquired property shall be on the person affected.",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68J - Burden of proof",
        "metaTitle": f"Section 68J - {ACT_HEADING}"
    },
    {
        "section": "Section 68K",
        "sectionNo": "68K",
...
(3) Where the person affected pays the fine due under sub-section (1), within such time as may be allowed in that behalf, the competent authority may, by order, revoke the declaration of forfeiture under section 68-I and thereupon such property shall stand released.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68K - Fine in lieu of forfeiture",
        "metaTitle": f"Section 68K - {ACT_HEADING}"
    },
    {
        "section": "Section 68L",
        "sectionNo": "68L",
...
(ii) any property acquired by the trust out of any contributions made by any person which would have been illegally acquired property in relation to such person had such person acquired such property out of such contributions.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68L - Procedure in relation to certain trust properties",
        "metaTitle": f"Section 68L - {ACT_HEADING}"
    },
    {
        "section": "Section 68M",
        "sectionNo": "68M",
...
(6) On application to the Appellate Tribunal and on payment of the prescribed fee, the Tribunal may allow a party to any appeal or any person authorised in his behalf by such party to inspect at any time during office hours, any relevant records and registers of the Tribunal and obtain a certified copy of any part thereof.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68-O - Appeals",
        "metaTitle": f"Section 68-O - {ACT_HEADING}"
    },
    {
        "section": "Section 68P",
        "sectionNo": "68P",
        ...
        "chapterRoman": "VA",
        "chapterName": "FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "title": "Notice or order not to be invalid for error in description",
        "description": "No notice issued or served, no declaration made, and no order passed, under this Chapter shall be deemed to be invalid by reason of any error in the description of the property or person mentioned therein if such property or person is identifiable from the description so mentioned.",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68P - Notice or order not to be invalid for error in description",
        "metaTitle": f"Section 68P - {ACT_HEADING}"
    },
    {
        "section": "Section 68Q",
        "sectionNo": "68Q",
    ...
    },
    {
        ...
        "chapterRoman": "VA",
        "chapterName": "FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "title": "Competent authority and Appellate Tribunal to have powers of civil court",
        "description": """The competent authority and the Appellate Tribunal shall have all the powers of a civil court while trying a suit under the Code of Civil Procedure, 1908 (5 of 1908), in respect of the following matters, namely:—
...
(f) any other matter which may be prescribed.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68R - Competent authority and Appellate Tribunal to have powers of civil court",
        "metaTitle": f"Section 68R - {ACT_HEADING}"
    },
    {
        "section": "Section 68S",
        "sectionNo": "68S",
...
(2) Every officer referred to in section 68T may furnish suo motu any information available with him to the competent authority if in the opinion of the officer such information will be useful to the competent authority for the purposes of this Chapter.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68S - Information to competent authority",
        "metaTitle": f"Section 68S - {ACT_HEADING}"
    },
    {
        "section": "Section 68T",
        "sectionNo": "68T",
        ...
        "chapterRoman": "VA",
        "chapterName": "FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "title": "Certain officers to assist Administrator, competent authority and Appellate Tribunal",
        "description": """For the purposes of any proceedings under this Chapter, the following officers are hereby empowered and required to assist the Administrator appointed under section 68G, competent authority and the Appellate Tribunal, namely:—
...
(j) such other officers of the Central or State Government as are specified by the Central Government in this behalf by notification in the Official Gazette.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68T - Certain officers to assist Administrator, competent authority and Appellate Tribunal",
        "metaTitle": f"Section 68T - {ACT_HEADING}"
    },
    {
        "section": "Section 68U",
        "sectionNo": "68U",
...
(3) Notwithstanding anything contained in sub-section (2), the Administrator may, for the purpose of taking possession of any property referred to in sub-section (1), requisition the service of any police officer to assist him and it shall be the duty of such officer to comply with such requisition.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68U - Power to take possession",
        "metaTitle": f"Section 68U - {ACT_HEADING}"
    },
    {
        "section": "Section 68V",
        "sectionNo": "68V",
        ...
        "description": """With a view to rectifying any mistakes apparent from record, the competent authority or the Appellate Tribunal, as the case may be, may amend any order made by it within a period of one year from the date of the order:
Provided that if any such amendment is likely to affect any person prejudicially, it shall not be made without giving to such person a reasonable opportunity of being heard.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68V - Rectification of mistakes",
        "metaTitle": f"Section 68V - {ACT_HEADING}"
    },
    {
        "section": "Section 68W",
        "sectionNo": "68W",
        ...
        "description": "No finding of any officer or authority under any other law shall be conclusive for the purposes of any proceedings under this Chapter.",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68W - Findings under other laws not conclusive for proceedings under this Chapter",
        "metaTitle": f"Section 68W - {ACT_HEADING}"
    },
    {
        "section": "Section 68X",
        "sectionNo": "68X",
        ...
        "chapterRoman": "VA",
        "chapterName": "FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "title": "Service of notices and orders",
        "description": """Any notice or order issued or made under this Chapter shall be served—
...
(b) if the notice or order cannot be served in the manner provided in clause (a), by affixing it on a conspicuous place in the property in relation to which the notice or order is issued or made or on some conspicuous part of the premises in which the person for whom it is intended is known to have last resided or carried on business or personally worked for gain.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68X - Service of notices and orders",
        "metaTitle": f"Section 68X - {ACT_HEADING}"
    },
    {
        "section": "Section 68Y",
        "sectionNo": "68Y",
        ...
        "chapterRoman": "VA",
        "chapterName": "FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "title": "Punishment for acquiring property in relation to which proceedings have been taken, under this Chapter",
        "description": "Any person who knowingly acquired, by any mode whatsoever, any property in relation to which proceedings are pending under this Chapter shall be punishable with imprisonment for a term which may extend to five years and with fine which may extend to fifty thousand rupees.",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68Y - Punishment for acquiring property in relation to which proceedings have been taken, under this Chapter",
        "metaTitle": f"Section 68Y - {ACT_HEADING}"
    },
    {
        "section": "Section 68Z",
        "sectionNo": "68Z",
        ...
        "description": """(1) Where the detention order of a detenu is set aside or withdrawn, properties seized or frozen under this Chapter shall stand released.
(2) Where any person referred to in clause (a) or clause (b) or clause (cc) of sub-section (2) of section 68A has been acquitted or discharged from the charges under this Act or any other corresponding law of any other country and the acquittal was not appealed against or when appealed against, the appeal was disposed of as a consequence of which such property could not be forfeited or warrant of arrest or authorisation of arrest issued against such person has been withdrawn, then, property seized or frozen under this Chapter shall stand released.""",
        "metaData": "Chapter VA FORFEITURE OF ILLEGALLY ACQUIRED PROPERTY",
        "metaDescription": f"{ACT_HEADING} Section 68Z - Release of property in certain cases",
        "metaTitle": f"Section 68Z - {ACT_HEADING}"
    },
...
(2) The Government may make rules consistent with this Act providing for the establishment, appointment, maintenance, management and superintendence of, and for supply of narcotic drugs and psychotropic substances from, the centres referred to in sub-section (1) and for the appointment, training, powers, duties and persons employed in such centres.""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 71 - Power of Government to establish centres for identification, treatment, etc., of addicts and for supply of narcotic drug and psychotropic substances",
        "metaTitle": f"Section 71 - {ACT_HEADING}"
    },
    {
        "section": "Section 72",
        "sectionNo": "72",
...
(2) When any person, in compliance with any rule made under this Act, gives a bond (other than a bond under section 34 and section 39) for the performance of any act, or for his abstention from any act, such performance or abstention shall be deemed to be a public duty within the meaning of section 74 of the Indian Contract Act, 1872 (9 of 1872); and upon breach of the conditions of such bond by him, the whole sum named therein as the amount to be paid in case of such breach may be recovered from him or from his surety (if any) as if it were an arrears of land revenue.""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 72 - Recovery of sums due to Government",
        "metaTitle": f"Section 72 - {ACT_HEADING}"
    },
    {
        "section": "Section 73",
        "sectionNo": "73",
        ...
        "chapterName": "MISCELLANEOUS",
        "title": "Bar of jurisdiction",
        "description": """No civil court shall entertain any suit or proceeding against any decision made or order passed by any officer or authority under this Act or under any rule made thereunder on any of the following matters, namely:—
...
(c) confiscation of opium found to be adulterated with any foreign substance.""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 73 - Bar of jurisdiction",
        "metaTitle": f"Section 73 - {ACT_HEADING}"
    },
    {
        "section": "Section 74",
        "sectionNo": "74",
    ...
    },
    {
        ...
        "description": "The Central Government may give such directions as it may deem necessary to a State Government regarding the carrying into execution of the provisions of this Act, and the State Government shall comply with such directions.",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 74A - Power of Central Government to give directions",
        "metaTitle": f"Section 74A - {ACT_HEADING}"
    },
    {
        "section": "Section 75",
        "sectionNo": "75",
        ...
        "description": """(1) The Central Government may, by notification in the Official Gazette, delegate, subject to such conditions and limitations as may be specified in the notification, such of its powers and functions under this Act (except the power to make rules) as it may deem necessary or expedient, to the Board or any other authority or the Narcotics Commissioner.
(2) The State Government may, by notification in the Official Gazette, delegate, subject to such conditions and limitations as may be specified in the notification, such of its powers and functions under this Act (except the power to make rules) as it may deem necessary or expedient, to any authority or officer of that Government.""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 75 - Power to delegate",
        "metaTitle": f"Section 75 - {ACT_HEADING}"
    },
    {
        "section": "Section 76",
        "sectionNo": "76",
        ...
        "description": """(1) Subject to the other provisions of this Act, the Central Government may, by notification in the Official Gazette, make rules for carrying out the purposes of this Act.
...
(h) any other matter which is to be, or may be, prescribed.""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 76 - Power of Central Government to make rules",
        "metaTitle": f"Section 76 - {ACT_HEADING}"
    },
    {
        "section": "Section 77",
        "sectionNo": "77",
    ...
    },
    {
        ...
        "description": """(1) Subject to the other provisions of this Act, the State Government may, by notification in the Official Gazette, make rules for carrying out the purposes of this Act.
(2) Without prejudice to the generality of the foregoing power, such rules may provide for all or any of the following matters, namely:—
...
(3) Every rule made by a State Government under this Act shall be laid, as soon as may be after it is made, before the Legislature of that State.""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 78 - Power of State Government to make rules",
        "metaTitle": f"Section 78 - {ACT_HEADING}"
    },
    {
        "section": "Section 79",
        "sectionNo": "79",
        ...
        "chapterRoman": "VI",
        "chapterName": "MISCELLANEOUS",
        "title": "Application of the Customs Act, 1962",
        "description": """All prohibitions and restrictions imposed by or under this Act on the import into India, the export from India and transhipment of narcotic drugs and psychotropic substances shall be deemed to be prohibitions and restrictions imposed by or under the Customs Act, 1962 (52 of 1962) and the provisions of that Act shall apply accordingly:
Provided that, where the doing of anything is an offence punishable under that Act and under this Act, nothing in that Act or in this section shall prevent the offender from being punished under this Act.""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 79 - Application of the Customs Act, 1962",
        "metaTitle": f"Section 79 - {ACT_HEADING}"
    },
    {
        "section": "Section 80",
        "sectionNo": "80",
        ...
        "chapterRoman": "VI",
        "chapterName": "MISCELLANEOUS",
        "title": "Application of the Drugs and Cosmetics Act, 1940 not barred",
        "description": "The provisions of this Act or the rules made thereunder shall be in addition to, and not in derogation of, the Drugs and Cosmetics Act, 1940 (23 of 1940) or the rules made thereunder.",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 80 - Application of the Drugs and Cosmetics Act, 1940 not barred",
        "metaTitle": f"Section 80 - {ACT_HEADING}"
    },
    {
        "section": "Section 81",
        "sectionNo": "81",
    ...
    },
    {
        ...
        "description": """(1) The Opium Act, 1857 (13 of 1857), the Opium Act, 1878 (1 of 1878) and the Dangerous Drugs Act, 1930 (2 of 1930) are hereby repealed.
(2) Notwithstanding such repeal, anything done or any action taken or purported to have been done or taken under any of the enactments repealed by sub-section (1) shall, in so far as it is not inconsistent with the provisions of this Act, be deemed to have been done or taken under the corresponding provisions of this Act.""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 82 - Repeal and savings",
        "metaTitle": f"Section 82 - {ACT_HEADING}"
    },
    {
        "section": "Section 83",
        "sectionNo": "83",
        ...
        "description": """(1) If any difficulty arises in giving effect to the provisions of this Act, the Central Government may, by order published in the Official Gazette, make such provisions not inconsistent with the provisions of this Act as appear to it to be necessary or expedient for removing the difficulty:
...
13 | | THC | Tetrahydrocannabinols, the following isomers: Δ6a(10a), Δ6a(7), Δ7, Δ8, Δ9, Δ10, Δ9(11) and their stereochemical variants
...
27 | PENTAZOCINE | | 1, 2, 3, 4, 5, 6-Hexahydro-6, 11-dimethyl-3-(3-methyl-2-butenyl)-2, 6-methano-3 benzazocin-8-ol
...
35 | CAMAZEPAM | | 7-Chloro-1, 3-dihydro-3-hydroxy-1-methyl-5-phenyl-2-H-1, 4 benezodiazepin-2-one dimethylcarbamate (ester)
...
40 | CLOTIAZEPAM | | 5-(0-Chlorophenyl)-7-ethyl-1, 3-dihydro-1-methyl-2H-thieno [2, 3-e]-1, 4-diazepine-2-one
41 | CLOXAZOLAM | | 10-Chloro-11b-(o-chlorophenyl)-2, 3, 7, 11b-tetrahydro-oxazolo-[3, 2-d] [1, 4] benzodiazepine-6 (5H)-one
...
47 | ETHYLLOFLAZEPATE | | Ethyl 7-chloro-5-(o-fluorophenyl)-2, 3-dihydro-2-oxo-1H-1, 4-benzodiazepine-3-carboxylate
48 | FLUDIAZEPAM | | 7-Chloro-5-(o-fluorophenyl)-1, 3-dihydro-1-methyl-2H-1, 4-benzodiazepine-2-one
49 | FLUNITRAZEPAM | | 5-(o-Fluorophenyl)-1, 3-dihydro-1-methyl-7-nitro-2H-1, 4-benzodiazepin-2-one
50 | FLURAZEPAM | | 7-Chloro-1-[2-(diethylamino) ethyl]-5-(o-fluorophenyl)-1, 3-dihydro-2H-1, 4-benzo-diazepin-2-one
51 | HALAZEPAM | | 7-Chloro-1, 3-dihydro-5-phenyl-1-(2, 2, 2-trifluoroethyl)-2H-1, 4-benzodiazepin-2-one
52 | HALOXAZOLAM | | 10-Bromo-11b-(o-fluorophenyl)-2, 3, 7, 11b-tetrahydrooxazolo [3, 2-d] [1, 4] benzodiazepine-6, (5H)-one
53 | KETAZOLAM | | 11-Chloro-8, 12b-dihydro-2, 8-dimethyl-12b-phenyl-4H-[1, 3]-oxazino-[3, 2-d] [1, 4] benzodiazepine-4, 7(6H)-dione
54 | LEFETAMINE | SPA | (—)-1-dimethylamino-1, 2diphenylethane
55 | LOPRAZOLAM | | 6-(o-Chlorophenyl)-2, 4-dihydro-2-[(4 methyl-1-piperazinyl) metnylene]-8-nitro-1H-imidazo [1, 2-0] [1, 4] benzodiazepin-1-one
56 | LORAZEPAM | | 7-Chloro-5-(o-chlorophenyl)-1, 3-dihydro-3-hydroxy-2H-1, 4-benzodiazepine-2-one
57 | LORMETAZEPAM | | 7-Chloro-5-(o-chlorophenyl)-1, 3-dihydro-3-hydroxy-1-methyl-2H-1, 4-benzcxiiazepine-2-one
...
73 | PRAZEPAM | | 7-Chlorol-(cyclopropylmethyl)-1,-3-dihydro-5-phenyl)-2H-1, 4-benzodiazepin-2-one
74 | TEMAZEPAM | | 7-Chloro-1, 3-dihydro-3-hydroxy-1-methyl-5-phenyl -2H-1-4-benzodiazepin-2-one
75 | TETRAZEPAM | | 7-Chloro-5-(cycloexen-1-yl)-1, 3-dihydro-1-methyl-2H-1, 4-benzodiazepin-2-one
...
83 | | N-ethyl MDA | (±) N-ethyl-u-methyl-4, 4 (methylenedioxy) phenethylamine
...
91 | | Delta-9-***tetrahydrocannabinol and stereochemical variants | (6a-R, 10aR)-6a, 7, 8, 10a-tctrahydro-6, 6, 9-trimethyl-3-penty 611-dibenzo [b-d] pyran-OI
...
110A | Ketamine | | 2-(2-cholorphenyl)-2-(methylamino) cyclohexanone
110B | MEPHEDRONE | 4-methylmethcathinone (4-MMC), 4-methylephedrone | (RS)-2-methylamino-1-(4-methylphenyl) propan-1-one.
110C | 25B-NBOMe | 2C-B-NBOMe | 2-(4-brome-2,5-dimethoxyphenyl)-N-(2-methoxybenzyl) ethanamine
...
110I | MDPV | 3,4-Methylenedioxypyrovalerone | (R/S)-1—(Benzo[d][1,3] dioxol-5-yl)-2-(pyrrolidine-1-yl) Pentan-1-one
110J | METHYLONE | Beta-keto-MDMA | (RS)-2-methylamino-1-(3,4-methylenedioxyphenyl) propan-1-one
110K | para-Methoxymethylamphetamine, PMMA | | 1-(4—methoxyphenyl)-N-methylpropan-2-amine
110L | a-Pyrrolidinovalerophenone, a-PVP | | 1-phenyl-2-(pyrrolidine-1-yl) pentan-1-one
...
110P | 4-Methylethcathinone | 4-MEC |
110Q | Ethylone | |
110R | Pentedrone | |
110S | Ethylphenidate | |
...
110Y | Tramadol | |
110Z | AB-CHMINACA | | N-[(2S)-1-Amino-3-methyl-1-oxobutan-2-yl]-1-(cyclohexylmethyl)-1H-indazole-3-carboxamide
110ZA | 5F-ADB(5F-MDMB-PINACA) | | Methyl(2S)-2-{1-5-fluorophentyl)-1H-indazole-3-carbonylamino}-3,3-dimethylbutanoate
110ZB | AB-PINACA | | N-[(2S)-1-Amino-3-methyl1oxobutan-2yl]-1-penty1H-indazole 3-carboxamide
...
110ZT | N-ethylnorpentylone | | 1-(2H-1,3-benzodioxol-5-yl)-2-(ethylamino)pentan-1-one""",
        "metaData": "Chapter VI MISCELLANEOUS",
        "metaDescription": f"{ACT_HEADING} Section 83 - Power to remove difficulties",
        "metaTitle": f"Section 83 - {ACT_HEADING}"
    }
]
...
def main():
    ...
    json_path = os.path.join(prisma_dir, "ndpsBearerActData.json")
    js_path = os.path.join(prisma_dir, "ndpsBearerActData.js")
    ...
    with open(js_path, "w", encoding="utf-8") as f:
        f.write(f"// {ACT_HEADING} Bearer Act Data with Full Chapter and Section Structure\n")
        f.write("export const ndpsBearerActSections = ")
        json.dump(sections, f, indent=2, ensure_ascii=False)
        f.write(";\n")

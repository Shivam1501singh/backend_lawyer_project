...
export const checkForbiddenBNSFields = (body) => {
...
export const createBNSSectionSchema = z.object({
  sectionNo: z
...
export const updateBNSSectionSchema = z.object({
  sectionNo: z
    .string()
    .trim()
...
export const getBNSQuerySchema = z.object({
  page: z
    .string()
    .optional()
    .default('1')
...
export const searchBNSQuerySchema = z.object({
  q: z
    .string()
    .optional()
    .default('')
